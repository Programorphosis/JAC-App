...
| # | Tarea | Estado | Archivos | Dependencias |
|---|-------|--------|----------|--------------|
| 7.0 | Configuración Wompi desde admin de junta (Mi JAC → Configuración) | ✅ | configuracion.component, mi-junta | - |
| 7.1 | Configurar junta de prueba con credenciales (mismas que plataforma) | ✅ | Manual, WOMPI_TARJETAS_PRUEBA_SANDBOX.md | 3.6 |
...
| 7.5 | Verificar que facturación plataforma no se afecta | ✅ | Pago online junta→plataforma implementado; webhook unificado con rama facturas (WOMPI_EVENTS_SECRET). Ver `FACTURACION_PLATAFORMA_PAGO_ONLINE_ANALISIS.md` | - |
...
| 8.4 | README o guía para configurar Wompi por junta | ✅ | docs/WOMPI_CONFIGURAR_JUNTA.md | - |
...
**Nota 7.5:** El pago online de facturas (junta→plataforma) está implementado. Webhook unificado con rama facturas; credenciales plataforma (WOMPI_EVENTS_SECRET) separadas de credenciales por junta.

---

## Checklist de completitud

- [x] Todas las tareas de Fase 1-6 marcadas
- [x] Pruebas E2E exitosas (Fase 7)
- [x] Documentación actualizada (Fase 8)
